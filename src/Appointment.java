...
class Appointmentform extends JFrame implements ActionListener{
...
public void actionPerformed(ActionEvent e) {
		...
		
	{
		try {
			...
			PreparedStatement Pstatement=connection.prepareStatement("insert into appointment(a_id,p_id,date,time) values(?,?,?,?) ");
